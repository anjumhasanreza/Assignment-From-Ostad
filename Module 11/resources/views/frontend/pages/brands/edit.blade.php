                                    ...
                                    <form action="{{ route('brand.update', $brand->id) }}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 mb-3 ">
                                                <label class="form-label" for="title">Brand Title <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="title"
                                                    id="title" placeholder="Enter brand title" value="{{ $brand->title }}">
                                            </div>
                                            ...
                                            <div class="col-lg-6 mb-3 ">
                                                <div class="mb-lg-0">
                                                    ...
                                                    <textarea class="form-control" name="description"
                                                        id="description" rows="1">{{ $brand->description }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 mb-3 ">
                                                ...
                                                <input type="text" class="form-control" name="remark"
                                                    id="remark" placeholder="Enter brand remark" value="{{ $brand->remark }}">
                                            </div>
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                <div class="mb-lg-0">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-select" name="status" id="choices-status-input" value="{{ $brand->status }}">
